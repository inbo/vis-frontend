...
export class HabitatOptionsService {
    ...
    constructor() {
        this._waterLevels = Object.keys(WaterLevel)
            .filter(value => isNaN(Number(value))).map(value => this.createOption('waterLevel', value));
        ...
        this._industry = [{text: 'surveyEvent.habitat.industry.true', value: true}, {
            text: 'surveyEvent.habitat.industry.false',
            value: false,
        },
