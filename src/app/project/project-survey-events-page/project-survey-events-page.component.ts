...
export class ProjectSurveyEventsPageComponent implements OnInit {
  ...
  navigateToSurveyEventDetail() {
    this.router.navigate(["/projecten", this.project.code.value, "waarnemingen", this.selectedSurveyEvent.surveyEventId.value])
  }
}
