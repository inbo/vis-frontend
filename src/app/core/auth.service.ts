...
export class AuthService implements OnDestroy {
  ...
  public get clientRoles(): Role[] {
    ...
    // @ts-ignore
    let roles: string[] = !identityClaims ? [] : !identityClaims.client_roles ? [] : identityClaims.client_roles
    ...
    roles.forEach(value => {
      switch (value) {
        ...
        case 'BEWERK_WAARNEMING':
          ...
          break;
        case 'VALIDEER_WAARNEMING':
          currentRoles.push(Role.ValidateSurveyEvent);
          break;
