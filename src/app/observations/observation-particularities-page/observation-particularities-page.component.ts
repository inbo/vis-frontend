...
@Component({
  selector: 'app-observation-particularities-page',
  templateUrl: './observation-particularities-page.component.html'
})
export class ObservationParticularitiesPageComponent implements OnInit {
  ...
  breadcrumbLinks: BreadcrumbLink[] = [
    ...
    {title: 'Bijzonderheden', url: '/projecten/' + this.activatedRoute.snapshot.params.projectCode + '/waarnemingen/' + this.activatedRoute.snapshot.params.observationId + '/bijzonderheden'}
  ]
  ...
  constructor(private titleService: Title, private visService: VisService, private activatedRoute: ActivatedRoute) {
    ...
    this.titleService.setTitle('Waarneming bijzonderheden ' + this.activatedRoute.snapshot.params.observationId)
