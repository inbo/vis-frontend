...
@Component({
  selector: 'app-observation-habitat-page',
  templateUrl: './observation-habitat-page.component.html'
})
export class ObservationHabitatPageComponent implements OnInit {
  ...
  breadcrumbLinks: BreadcrumbLink[] = [
    ...
    {title: 'Habitat', url: '/projecten/' + this.activatedRoute.snapshot.params.projectCode + '/waarnemingen/' + this.activatedRoute.snapshot.params.observationId + '/habitat'}
  ]
  ...
  constructor(private titleService: Title, private visService: VisService, private activatedRoute: ActivatedRoute) {
    ...
    this.titleService.setTitle('Waarneming habitat ' + this.activatedRoute.snapshot.params.observationId)
