...
@Component({
  selector: 'observation-detail-page',
  templateUrl: './observation-detail-page.component.html'
})

export class ObservationDetailPageComponent implements OnInit {
  ...
  constructor(private titleService: Title, private visService: VisService, private activatedRoute: ActivatedRoute) {
    ...
    this.titleService.setTitle('Waarneming algemeen ' + this.activatedRoute.snapshot.params.observationId)
